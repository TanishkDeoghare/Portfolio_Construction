...
# scaled_random_numbers_df.transpose().to_excel("C:/Users/tanishk.deoghare/OneDrive - Angel Oak Capital Advisors/Desktop/Portfolio Construction/Dry Run 1/scaled_random_numbers_sector_allocations.xlsx")
# scaled_random_numbers_df = scaled_random_numbers_df[2:].div(scaled_random_numbers_df[2:].sum(axis=0), axis=1)
